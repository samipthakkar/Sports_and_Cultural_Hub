...
public class T_Sports_Indi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.t_sports_indi_layout);
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.btnannouncesport)
        {
            Intent i=new Intent(T_Sports_Indi.this,Announcement.class);
            startActivity(i);
            finish();
        }
        if(v.getId()==R.id.btnpushemailsport)
        {
            Toast toast= Toast.makeText(getApplicationContext(), "Redirecting...", Toast.LENGTH_SHORT);
            toast.show();
            new MyTask().execute();
        }
        if(v.getId()==R.id.btnpushsport)
        {
            Toast.makeText(T_Sports_Indi.this, "Push Notification Feature Coming Soon!", Toast.LENGTH_SHORT).show();
        }
    ...
    private class MyTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            try {
                ...
                String sql = "select Student_emailid from `Registration` where `Activity`='"+sport+"'";
        ...
        protected void onPostExecute(Void aVoid) {
            if(eflag==0) {
                ...
                Intent i = new Intent(T_Sports_Indi.this, Email.class);
